...
export const classController = {
    ...
    assignStudents: asyncHandler(async (req, res) => {
        requireAdmin(req);
        return sendSuccess(res, await classService.assignStudents(Number(req.params.id), req.body.ids), "Students assigned");
    }),
    assignTeachers: asyncHandler(async (req, res) => {
        requireAdmin(req);
        return sendSuccess(res, await classService.assignTeachers(Number(req.params.id), req.body.ids), "Teachers assigned");
    }),
};
