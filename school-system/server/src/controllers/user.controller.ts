...
const requireAdmin = (req: Request) => {
  ...
  if (req.user.role !== "ADMIN") throw new AppError("Only admin can access this resource", 403);
};
...
export const userController = {
  ...
  delete: asyncHandler(async (req, res) => {
    ...
    if (req.user?.id === userId) throw new AppError("You cannot delete your own account", 400);
